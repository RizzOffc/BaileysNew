...
<div align="center"><img src="https://img101.pixhost.to/images/369/551696826_rizz.jpg"></div>
...
```json
"dependencies": {
    "baileys": "github:RizzOffc/BaileysNew"
}
```
or install in terminal:
```
npm install baileys@github:RizzOffc/BaileysNew
```
